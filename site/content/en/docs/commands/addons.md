...
## minikube addons docs

Open documentation for ADDON_NAME in a browser

### Synopsis

Open documentation for ADDON_NAME in a browser. For a list of available addons use: minikube addons list

```shell
minikube addons docs ADDON_NAME [flags]
```

### Examples

```
minikube addons docs dashboard
```
